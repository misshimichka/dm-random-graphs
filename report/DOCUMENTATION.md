...
##### `build_dataset(distribution_1, distribution_2, d1_param, d2_param, dataset_size, n_samples, dist)`

Строит набор данных из характеристик дистанционного графа
...
| dist | `float` | Пороговое расстояние |
...
Авторы документации: DeepSeek и Тася (Дима, если будешь обновлять документацию, впиши себя тоже!)
