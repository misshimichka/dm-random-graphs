...
def normal_distribution(sigma: float, n: int, random_state: int = None) -> np.ndarray:
    """
    Fuction generate sample from skewnormal distribution.
...
def lognormal_distribution(sigma: float, n: int, random_state: int = None) -> np.ndarray:
    """
    Fuction generate sample from skewnormal distribution.
...
def exp_distribution(lambda_: float, n: int, random_state: int = None) -> np.ndarray:
    """
    Fuction generate sample from skewnormal distribution.
